...
class MonthlyAttendance(BaseModel):
    ...
    total_meetings = models.PositiveIntegerField(
        default=0,
        verbose_name='Total de Reuniões'
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(
                check=models.Q(attendance_percentage__gte=0.00, attendance_percentage__lte=100.00),
    ...
    def clean(self):
        ...
        should_be_faithful = self.attendance_percentage >= 75.00 if self.total_meetings > 0 else False
    ...
    def calculate_derived_fields(self):
        ...
        if self.total_meetings > 0:
            self.attendance_percentage = (self.attendances / self.total_meetings) * 100
    ...
    def calculate_for_member_cell_month(cls, member, cell, year, month):
        ...
        from meeting_attendance.models import MeetingAttendance
    ...
    def update_or_create_from_meetings(cls, member, cell, year, month):
        ...
        """
        instance = cls.calculate_for_member_cell_month(member, cell, year, month)
    ...
    def summary(self):
        ...
        if self.total_meetings == 0:
            return f"{self.member_name} - {self.month_year_display}: Sem reuniões"
